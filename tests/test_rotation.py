...
class RotationTests(unittest.TestCase):
    """Tests for 'spatial.py' rotation()."""

    def __check_matrix(self, r, m):
        """ Checks the elements of a 2D 3x3 affine rotation matrix """
        self.assertAlmostEqual(r[0, 0], m[0, 0])
        self.assertAlmostEqual(r[0, 1], m[0, 1])
        self.assertAlmostEqual(r[0, 2], m[0, 2])

        self.assertAlmostEqual(r[1, 0], m[1, 0])
        self.assertAlmostEqual(r[1, 1], m[1, 1])
        self.assertAlmostEqual(r[1, 2], m[1, 2])

        self.assertAlmostEqual(r[2, 0], m[2, 0])
        self.assertAlmostEqual(r[2, 1], m[2, 1])
        self.assertAlmostEqual(r[2, 2], m[2, 2])
    ...
    def test_matrix_30(self):
        ...
        m = matrix([[0.866025403784439, -0.5, 0], [0.5, 0.866025403784439, 0], [0, 0, 1]])
        self.__check(30, m)
    ...
    def test_matrix_135(self):
        ...
        m = matrix([[-0.707106781186547, -0.707106781186548, 0], [0.707106781186548, -0.707106781186547, 0], [0, 0, 1]])
        self.__check(135, m)
    ...
    def test_matrix_180(self):
        ...
        m = matrix([[-1, -1.22460635382238E-16, 0], [1.22460635382238E-16, -1, 0], [0, 0, 1]])
        self.__check(180, m)
    ...
    def test_matrix_270(self):
        ...
        m = matrix([[-1.83690953073357E-16, 1, 0], [-1, -1.83690953073357E-16, 0], [0, 0, 1]])
        self.__check(270, m)
    ...
    def test_matrix_370(self):
        ...
        m = matrix([[0.984807753012208, -0.17364817766693, 0], [0.17364817766693, 0.984807753012208, 0], [0, 0, 1]])
        self.__check(370, m)
